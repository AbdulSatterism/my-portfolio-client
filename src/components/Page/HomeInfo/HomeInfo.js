        ...
        <div className="hero bg-gradient-to-b from-blue-950">
            <div className="flex-col hero-content lg:flex-row-reverse">
                ...
                <div className='px-8'>
                    ...
                    <p className="py-6 text-xl text-white">i am expert as a MERN stack developer.I have the ability to build web applications that deliver exceptional results.I am expert and comfortable in HTML,CSS,Tailwind CSS,Javascript,React js,Mongodb,Node js, Express js.</p>
